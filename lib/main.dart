...
import 'package:local_db_lesson/blocs/get_balance/get_balance_bloc.dart';
...
import 'package:local_db_lesson/views/dashboard_screen.dart';
...
void main() async {
  ...
  Hive
    ...
    ..registerAdapter(TransferAdapter());
  runApp(const MyApp());
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_) => AddBalanceBloc()),
        BlocProvider(create: (_) => SendMoneyBloc()),
        BlocProvider(
            create: (_) => TransferHistoryBloc()..add(GetTransferHistory())),
        BlocProvider(create: (_) => GetBalanceBloc()..add(GetBalance())),
      ],
      child: MaterialApp(
        title: 'Flutter Demo',
        theme: ThemeData(
